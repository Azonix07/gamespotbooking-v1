...
export const malayalamUI = {
  title: "AI സഹായി",
  close: "അടയ്ക്കുക",
  languageToggle: { english: "EN", malayalam: "ML" },
  recommendations: {
  ...
  buttons: { send: "അയയ്ക്കുക", voice: "ശബ്ദം", stopVoice: "നിർത്തുക", clearSession: "പുതിയ സംഭാഷണം ആരംഭിക്കുക" },
  voice: { listening: "കേൾക്കുന്നു...", speaking: "സംസാരിക്കുന്നു...", notSupported: "നിങ്ങളുടെ ബ്രൗസർ വോയ്സ് തിരിച്ചറിയൽ പിന്തുണയ്ക്കുന്നില്ല", clickToSpeak: "സംസാരിക്കാൻ ക്ലിക്ക് ചെയ്യുക" },
  loading: { thinking: "ചിന്തിക്കുന്നു...", processing: "പ്രോസസ്സ് ചെയ്യുന്നു...", typing: "ടൈപ്പ് ചെയ്യുന്നു..." },
  errors: { sendFailed: "സന്ദേശം അയയ്ക്കാൻ കഴിഞ്ഞില്ല", networkError: "നെറ്റ്‌വർക്ക് പിശക്", tryAgain: "വീണ്ടും ശ്രമിക്കുക" },
  session: { newConversation: "പുതിയ സംഭാഷണം ആരംഭിച്ചു", cleared: "സെഷൻ ക്ലിയർ ചെയ്തു" },
  booking: {
...
export const englishUI = {
  ...
  buttons: { send: "Send", voice: "Voice", stopVoice: "Stop", clearSession: "Start New Conversation" },
  voice: { listening: "Listening...", speaking: "Speaking...", notSupported: "Voice recognition not supported in your browser", clickToSpeak: "Click to speak" },
  loading: { thinking: "Thinking...", processing: "Processing...", typing: "Typing..." },
  errors: { sendFailed: "Failed to send message", networkError: "Network error", tryAgain: "Try again" },
  session: { newConversation: "New conversation started", cleared: "Session cleared" },
  booking: {
