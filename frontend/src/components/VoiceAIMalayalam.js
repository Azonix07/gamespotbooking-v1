...
const VoiceAIMalayalam = ({ isOpen, onClose }) => {
  ...
  const aiKnowledge = useMemo(() => ({
    ...
    timing: {
      ...
      responses: [
        'ഗെയിംസ്പോട്ട് പ്രവർത്തന സമയം: എല്ലാ ദിവസവും രാവിലെ ഒൻപത് മണി മുതൽ രാത്രി പന്ത്രണ്ട് മണി (മിഡ്നൈറ്റ്) വരെ.',
        'എല്ലാ ദിവസവും 9 AM മുതൽ 12 AM (മിഡ്നൈറ്റ്) വരെ. ഹോളിഡേകളിൽ പ്രത്യേക സമയം ഉണ്ടാകും.',
        'ഞങ്ങൾ എല്ലാ ദിവസവും രാവിലെ 9 മണി മുതൽ രാത്രി 12 മണി വരെ തുറന്നിരിക്കും!'
      ]
    },
    ...
    help: {
      ...
      responses: [
        ...
        'FAQ: 1. Price - 80/hour, 2. Timing - 9 AM to 12 AM (Midnight) daily, 3. Location - Kodungallur.'
      ]
    },
